// Shared IDX Broker proxy logic used by app/api/idx/[...path]/route.ts.
// Keeps IDX_BROKER_ACCESS_KEY server-side only: the browser only ever talks
// to same-origin /api/idx/* routes.
